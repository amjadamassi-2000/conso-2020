      ...
      child: Column(
        children: [
          getRow(
              ...
              Row(
                children: [
                  textBody('ذهاب و إياب',
                      color: defaultColor, fontSize: textSize),
                  SizedBox(
                    width: 5.w,
                  ),
                  Icon(
          ...
          getRow('الجهة', 'جدة - السعودية',
              textBody('250ريال', color: defaultColor, fontSize: 18.sp)),
          SizedBox(
            height: 5.h,
          ),
//          getRow(
...
//              Row(
//                children: [
//                  textBody('موعد الوصول',
//                      color: defaultHint, fontSize: textSize),
//                  SizedBox(
//                    width: 7.w,
//                  ),
//                  textBody('11/01/2021',
...
//
          ...
          getRow(
              'تاريخ الطلب',
              '03/01/2021',
              textBody('قيد المراجعة',
                  color: statusWaitingPreview, fontSize: textSize),
          ),
