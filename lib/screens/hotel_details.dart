                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Spacer(),
                              textBodyMedium('ريال 450', color: defaultColor,
                                  fontSize: 18.sp)
                            ],
                          ),
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Divider(
                                  thickness: 1, height: 1, color: defaultHint,),
                                Padding(
    ...
    return Expanded(
      child: Container(
        ...
        child: Row(
          ...
          children: [
            svgImage(icon,size: 15.r,color: isActivate?Colors.blue: Colors.black54),
            SizedBox(width: 5.w,) ,
      ...
      children: [
        ...
        Container(
          ...
          child: Row(children: [
            ...
            SizedBox(width: 5.w,) ,
            Expanded(child: textBodyBigSkinny('طريق الخبر - الدمام ، 31952 الخبر ، المملكة العربية السعودية',fontSize: 14.sp,color: defaultColor))
          ],),
        ),
        Container(
            padding: EdgeInsets.symmetric(horizontal: 15.r),
            child: Expanded(child: textBodyBigSkinny('هذا النص هو مثال لنص يمكن أن يستبدل في نفس ، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة عدد الحروف التى يولدها التطبيقإذا كنت تحتاج إلى عدد أكبر من الفقرات يتيح لك مولد النص العربى زيادة عدد الفقرات كما تريد، النص لن يبدو مقسما ولا يحوي أخطاء لغوية، مولد النص العربى مفيد لمصممي المواقع على وجه الخصوص، حيث يحتاج العميل فى كثير من الأحيان أن يطلع على صورة حقيقية لتصميم الموقع',textAlign: TextAlign.start,fontSize: 12.sp,color: defaultTextColor)))
