...
class NavDrawerSearchPlan extends StatefulWidget {
...
class _NavDrawerSearchState extends State<NavDrawerSearchPlan> {
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            textBodyBigSkinny('journey_duration'.t, color: defaultColor),
            FlutterSliderCustom(onDragging:(handlerIndex, lowerValue, upperValue) {
            ...
            textBodyBigSkinny('waiting_point'.t, color: defaultColor),
            DropdownButton<String>(
              items: <String>['أقرب مغادرة ( القاهرة )', 'أقرب مغادرة ( القاهرة )2', 'أقرب مغادرة ( القاهرة )3', 'D'].map((String value) {
                return DropdownMenuItem<String>(
                  value: value,
            ...
            textBodyBigSkinny('Airline'.t, color: defaultColor),
            DropdownButton<String>(
              items: <String>['أقرب مغادرة ( القاهرة )', 'أقرب مغادرة ( القاهرة )2', 'أقرب مغادرة ( القاهرة )3', 'D'].map((String value) {
                return DropdownMenuItem<String>(
                  value: value,
